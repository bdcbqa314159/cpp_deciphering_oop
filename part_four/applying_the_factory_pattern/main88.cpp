...
public:
    ...
    static Student *MatriculateStudent(const string &, const string &, const string &, char, const string &, float, const string &, const string &);
...
Student *Student::MatriculateStudent(const string &degree, const string &fn, const string &ln, char mi,
